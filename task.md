...
- [ ] **DEV-2104**: [Dev Architect / Senior SDE] Configure package scripts (`dev`, `build`, `test`, `lint`, `typecheck`, `tauri`) and install core dependencies.
- [ ] **DEV-2105**: [Dev Architect / Senior SDE] Author comprehensive `README.md` with Windows desktop development setup, prerequisites, and clean checkout instructions.
- [ ] **DEV-2106**: [Dev Architect / Senior SDE] Conduct Dev Technical Code Acceptance Review.
